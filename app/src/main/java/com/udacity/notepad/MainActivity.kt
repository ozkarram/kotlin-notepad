...
class MainActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        customRecyclerView.addItemDecoration(SpaceItemDecoration(this, R.dimen.margin_small))
        customRecyclerView.adapter = NotesAdapter(this)
    }
    ...
    private fun refresh() {
        (customRecyclerView.adapter as NotesAdapter).refresh()
    }
}
